...
#define NOFILE	24			/* Number of user open files */
...
#define NMICALL		74		/* Machine independent system calls
					 * (was 88 here while const.h said 74:
					 * an imported inconsistency -- the
					 * 3.2.1b table ends at 73/tick and no
					 * handler beyond it exists; ONE value
					 * everywhere or sysitab[] layouts
