...
#include <sys/types.h>
#include <sys/poll.h>	/* event_t (pollable pipes, k72) */
...
typedef struct inode {
	...
	union ia_u {
		...
		struct ip_s {		/* Pipes */
			...
			int	ip_prx;
			int	ip_pwx;
			int	ip_par;	/* Number Awake Readers */
			int	ip_paw;	/* Number Awake Writers */
			int	ip_psr;	/* Number Sleeping Readers */
			int	ip_psw;	/* Number Sleeping Writers */
