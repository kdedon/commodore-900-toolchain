 ...
 */
/*
 * Wait forever.  poll(2)'s timeout is a plain int here, so this is the
 * traditional SVR4 spelling of -1 and nothing more; programs written against
 * BSD select() spell the same thing as a null struct timeval.
 */
#define INFTIM	(-1)
