...
#ifndef B0	/* sgtty.h may precede in the kernel; its codes then win */
#define	B0	0		/* Hang up */
...
/*
 * Names for TCFLSH's argument (the POSIX spellings).  The sgtty line
 * discipline cannot honour the distinction and always flushes both
 * queues; see libc/gen/tcflush.c.
 */
#define	TCIFLUSH	0	/* input queue */
#define	TCOFLUSH	1	/* output queue */
#define	TCIOFLUSH	2	/* both */
#endif
#endif
