...
#define	VRAM	(VMBASE+7)	/* pooled DCONs go to SDATA, not SLINK */
...
#define	VPIC	(VMBASE+9)	/* reach extern data not defined here through
				 * a 4-byte far-pointer slot in the literal
				 * pool, bound at exec */
